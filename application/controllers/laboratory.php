...
class laboratory extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->laboratory_model->new_report();

            $num_rapport = $this->laboratory_model->num_rapport()->num_rapport;

            $this->laboratory_model->fetch_data1(
              $exams_t,
              $blood_n,
              $blood_t,
              $plasmodium_p,
            ...
            $this->laboratory_model->fetch_data2(
            ...
            $this->load->view('laboratory_add_view');
        }
    }
}
