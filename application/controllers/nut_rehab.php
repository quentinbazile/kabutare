...
class nut_rehab extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->nut_rehab_model->new_report();

            $num_rapport = $this->nut_rehab_model->num_rapport()->num_rapport;

            $this->nut_rehab_model->fetch_data1(
              $e_beds,
              $e_present_start,
              $e_admissions,
              $e_referred,
            ...
            $this->nut_rehab_model->fetch_data2(
              $hosp_1m,
              $hosp_1f,
            ...
            $this->nut_rehab_model->fetch_data3(
              $screened_6,
              $screened_7,
              $screened_2,
              $screened_5,
            ...
            $this->nut_rehab_model->fetch_data4(
            $present_start_mod4,
            $present_start_mod5,
            $present_start_sev4,
            $present_start_sev5,
            ...
            $this->load->view('nut_rehab_add_view');
        }
    }
}
