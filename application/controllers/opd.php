...
class opd extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->opd_model->new_report();

            $num_rapport = $this->opd_model->num_rapport()->num_rapport;

            $this->opd_model->fetch_data1(
              $nc5m,
              $nc5f,
              $nc19f,
              $nc19m,
