...
class emergency extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->emergency_model->new_report();

            $num_rapport = $this->emergency_model->num_rapport()->num_rapport;

            $this->emergency_model->fetch_data1(
          $nc5m,
            $nc5f,
            $nc19f,
            $nc19m,
          ...
          $nc_catch,
            ...
            $this->load->view('emergency_add_view');
        }
    }
}
