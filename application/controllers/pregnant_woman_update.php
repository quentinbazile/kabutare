...
class pregnant_woman_update extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->pregnant_woman_model->update_data1(
              $nc5m,
              $nc5f,
              $nc19f,
              $nc19m,
            ...
            $this->pregnant_woman_model->update_data2(
              $complications_opd19,
              $complications_opd20,
              $ectopic_opd19,
              $ectopic_opd20,
            ...
            $this->pregnant_woman_model->update_data3(
              $lung,
              $bones,
              $abdomen_without,
              $abdomen_with,
            ...
            $data['table1'] = $this->pregnant_woman_model->show_table1();
            $data['table2'] = $this->pregnant_woman_model->show_table2();
            $data['table3'] = $this->pregnant_woman_model->show_table3();
            $this->load->view('pregnant_woman_update_view', $data);
        }
    }
}
