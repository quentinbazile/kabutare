...
class surgery_update extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->surgery_model->update_data1(
              $s_beds,
              $s_present_start,
              $s_admissions,
              $s_referred,
            ...
            $this->surgery_model->update_data2(
              $hosp_1m,
              $hosp_1f,
              $hosp_4m,
              $hosp_4f,
            ...
            $data['table1'] = $this->surgery_model->show_table1();
            $data['table2'] = $this->surgery_model->show_table2();
            $this->load->view('surgery_update_view', $data);
        }
    }
}
