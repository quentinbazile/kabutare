...
class pediatrics extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->pediatrics_model->new_report();

            $num_rapport = $this->pediatrics_model->num_rapport()->num_rapport;

            $this->pediatrics_model->fetch_data1(
              $p_beds,
              $p_present_start,
              $p_admissions,
              $p_referred,
            ...
            $this->pediatrics_model->fetch_data2(
              $hosp_1m,
              $hosp_1f,
              $hosp_4m,
              $hosp_4f,
            ...
            $this->load->view('pediatrics_add_view');
        }
    }
}
