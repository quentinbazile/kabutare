...
class mental_health_update extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->mental_health_model->update_data1(
          $nc5m,
            $nc5f,
            $nc19f,
            $nc19m,
          ...
          $nc_catch,
            ...
            $this->mental_health_model->update_data2(
              $follow_up,
                $higher_level,
                $hospitalized,
              $anxiety_nc19m,
            ...
            $data['table1'] = $this->mental_health_model->show_table1();
            $data['table2'] = $this->mental_health_model->show_table2();
            $this->load->view('mental_health_update_view', $data);
        }
    }
}
