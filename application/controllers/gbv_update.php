...
class gbv_update extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
          ...
          $nc_catch,
            ...
            $data['table1'] = $this->gbv_model->show_table1();
            $data['table2'] = $this->gbv_model->show_table2();
            $this->load->view('gbv_update_view', $data);
        }
    }
}
