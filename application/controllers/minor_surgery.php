...
class minor_surgery extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $this->minor_surgery_model->new_report();

            $num_rapport = $this->minor_surgery_model->num_rapport()->num_rapport;

            $this->minor_surgery_model->fetch_data1(
              $appendice_urg,
              $appendice_plan,
              $hernioraphy_urg,
              $hernioraphy_plan,
            ...
            $this->minor_surgery_model->fetch_data2(
              $general,
              $regional,
              $local,
              $other_type,
            ...
            $this->load->view('minor_surgery_add_view');
        }
    }
}
