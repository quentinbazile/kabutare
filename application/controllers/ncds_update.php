...
class ncds_update extends CI_Controller
{
    ...
    public function fetch()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $data['table1'] = $this->ncds_model->show_table1();
            $data['table2'] = $this->ncds_model->show_table2();
            $data['table3'] = $this->ncds_model->show_table3();
            $this->load->view('ncds_update_view', $data);
        }
    }
}
