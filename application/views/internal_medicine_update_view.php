          ...
          <h4>Causes of hospitalization and death at discharge</h4>
  	      <table id="E10" class="center">
              ...
              <tr>
  	            ...
  	            <td><input type="number" min="0" name="gastritis_death19m" class="form-control" value="<?php echo $table2->gastritis_death19m; ?>"></td>
  	            <td><input type="number" min="0" name="gastritis_death19f" class="form-control" value="<?php echo $table2->gastritis_death19f; ?>"></td>
  	            <td><input type="number" min="0" name="gastritis_death20m" class="form-control" value="<?php echo $table2->gastritis_death20m; ?>"></td>
  	            <td><input type="number" min="0" name="gastritis_death20f" class="form-control" value="<?php echo $table2->gastritis_death20f; ?>"></td>
  	          </tr>
              <tr>
