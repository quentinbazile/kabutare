<html>
	...
	<body>
		<div class="container">
			<h2>Surgery - Report of <?php echo date('d/m/Y', strtotime($this->session->userdata('update_date'))); ?></h2>
			<div>
        <form method="post" action="" class="form-inline">
            ...
            <div class="row">
                      ...
                      <td>1</td>
					            ...
					            <td><input type="number" min="0" name="s_beds" class="form-control" value="<?php echo $table1->s_beds; ?>"></td>
					          </tr>
					          <tr>
                      <td>2</td>
					            <td class="left">Present at the beginning of the month</td>
					            <td><input type="number" min="0" name="s_present_start" class="form-control" value="<?php echo $table1->s_present_start; ?>"></td>
					          </tr>
                    <tr>
                      <td>3</td>
					            <td class="left">Admissions during the month of wich</td>
					            <td><input type="number" min="0" name="s_admissions" class="form-control" value="<?php echo $table1->s_admissions; ?>"></td>
					          </tr>
                    <tr>
                      <td>3.1</td>
					            <td class="left">Referred from the health center</td>
					            <td><input type="number" min="0" name="s_referred" class="form-control" value="<?php echo $table1->s_referred; ?>"></td>
					          </tr>
                    <tr>
                      <td>3.2</td>
					            <td class="left">Non-referred patients</td>
					            <td><input type="number" min="0" name="s_no_referred" class="form-control" value="<?php echo $table1->s_no_referred; ?>"></td>
					          </tr>
                    <tr>
                      <td>4</td>
					            <td class="left">Discharges during the month of which</td>
					            <td><input type="number" min="0" name="s_discharges" class="form-control" value="<?php echo $table1->s_discharges; ?>"></td>
					          </tr>
                    <tr>
                      <td>4.1</td>
					            <td class="left">Authorized / Cured</td>
					            <td><input type="number" min="0" name="s_authorized" class="form-control" value="<?php echo $table1->s_authorized; ?>"></td>
					          </tr>
                    <tr>
                      <td>4.2</td>
					            <td class="left">Abandoned</td>
					            <td><input type="number" min="0" name="s_abandoned" class="form-control" value="<?php echo $table1->s_abandoned; ?>"></td>
					          </tr>
                    <tr>
                      <td>4.3</td>
					            <td class="left">Deaths</td>
					            <td><input type="number" min="0" name="s_deaths" class="form-control" value="<?php echo $table1->s_deaths; ?>"></td>
					          </tr>
                    <tr>
                      <td>4.4</td>
					            <td class="left">Referred</td>
					            <td><input type="number" min="0" name="s_dis_referred" class="form-control" value="<?php echo $table1->s_dis_referred; ?>"></td>
					          </tr>
                    <tr>
                      <td>4.5</td>
					            <td class="left">Counter-referred</td>
					            <td><input type="number" min="0" name="s_counter" class="form-control" value="<?php echo $table1->s_counter; ?>"></td>
					          </tr>
                    <tr>
                      <td>5</td>
					            <td class="left">Present at the end of the month</td>
					            <td><input type="number" min="0" name="s_present_end" class="form-control" value="<?php echo $table1->s_present_end; ?>"></td>
					          </tr>
                    <tr>
                      <td>6</td>
					            <td class="left">Total hospitalization days for discharged patients</td>
					            <td><input type="number" min="0" name="s_total" class="form-control" value="<?php echo $table1->s_total; ?>"></td>
					          </tr>
                    <tr>
                      <td>7</td>
					            <td class="left">Actual hospitalization days</td>
					            <td><input type="number" min="0" name="s_actual" class="form-control" value="<?php echo $table1->s_actual; ?>"></td>
					          </tr>
					        </tbody>
					      </table>
							</div>
