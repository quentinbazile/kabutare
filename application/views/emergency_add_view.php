        ...
        <form method="post" action="" class="form-inline">
            ...
            <h4>Causes of hospitalization and death at discharge</h4>
                ...
                <tr>
			            ...
			            <td><input type="number" min="0" name="gastritis_death5m" class="form-control"></td>
			            <td><input type="number" min="0" name="gastritis_death5f" class="form-control"></td>
			            <td><input type="number" min="0" name="gastritis_death19m" class="form-control"></td>
			            <td><input type="number" min="0" name="gastritis_death19f" class="form-control"></td>
			            <td><input type="number" min="0" name="gastritis_death20m" class="form-control"></td>
			            <td><input type="number" min="0" name="gastritis_death20f" class="form-control"></td>
			          </tr>
                <tr>
