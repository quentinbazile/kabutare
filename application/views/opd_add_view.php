<html>
	...
	<body>
		<div class="container-fluid">
			<h2>OPD - Report of <?php echo date('d/m/Y', strtotime($this->session->userdata('add_date'))); ?></h2>
			<div>
              ...
              <table id="F2" class="center">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="number" min="0" name="fractures_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="fractures_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="fractures_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="fractures_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="fractures_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="fractures_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td class="left">Physical traumas, other than fractures</td>
                    <td><input type="number" min="0" name="phys_traumas_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="phys_traumas_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="phys_traumas_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="phys_traumas_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="phys_traumas_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="phys_traumas_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>3</td>
                    <td class="left">Bone and joint disorder, other than fractures</td>
                    <td><input type="number" min="0" name="bone_joint_disord_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="bone_joint_disord_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="bone_joint_disord_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="bone_joint_disord_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="bone_joint_disord_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="bone_joint_disord_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>4</td>
                    ...
                    <td class="grey"></td>
                    <td class="grey"></td>
                    <td><input type="number" min="0" name="gyneco_pb_19f" class="form-control"></td>
                    <td class="grey"></td>
                    <td><input type="number" min="0" name="gyneco_pb_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>5</td>
                    <td class="left">AIDS clinical</td>
                    <td><input type="number" min="0" name="aids_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="aids_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="aids_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="aids_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="aids_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="aids_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>6</td>
                    <td class="left">Skin infection opportunistic</td>
                    <td><input type="number" min="0" name="si_opport_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="si_opport_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="si_opport_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="si_opport_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="si_opport_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="si_opport_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>7</td>
                    <td class="left">Herpes zoster (zona/shingles)</td>
                    <td><input type="number" min="0" name="herpes_z_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="herpes_z_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="herpes_z_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="herpes_z_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="herpes_z_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="herpes_z_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>8</td>
                    <td class="left">Candidiasis oral</td>
                    <td><input type="number" min="0" name="cand_oral_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="cand_oral_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="cand_oral_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="cand_oral_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="cand_oral_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="cand_oral_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>9</td>
                    <td class="left">Fever chronic (>1 month)</td>
                    <td><input type="number" min="0" name="fever_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="fever_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="fever_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="fever_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="fever_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="fever_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>10</td>
                    <td class="left">Diarrhea chronic opportunistic infections</td>
                    <td><input type="number" min="0" name="diar_chro_opp_infect_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="diar_chro_opp_infect_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="diar_chro_opp_infect_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="diar_chro_opp_infect_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="diar_chro_opp_infect_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="diar_chro_opp_infect_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>11</td>
                    <td class="left">Needle stick-injuries (or other health worker HIV exposure)</td>
                    <td><input type="number" min="0" name="needle_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="needle_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="needle_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="needle_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="needle_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="needle_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>12</td>
                    <td class="left">Goitre</td>
                    <td><input type="number" min="0" name="goitre_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="goitre_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="goitre_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="goitre_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="goitre_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="goitre_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>13</td>
                    <td class="left">Vitamin A deficiency - Night blindness</td>
                    <td><input type="number" min="0" name="va_def_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="va_def_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="va_def_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="va_def_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="va_def_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="va_def_20f" class="form-control"></td>
                  </tr>
                  <tr>
                    <td>14</td>
                    <td class="left">Leprosy (MB + PB)</td>
                    <td><input type="number" min="0" name="leprosy_5m" class="form-control"></td>
                    <td><input type="number" min="0" name="leprosy_5f" class="form-control"></td>
                    <td><input type="number" min="0" name="leprosy_19m" class="form-control"></td>
                    <td><input type="number" min="0" name="leprosy_19f" class="form-control"></td>
                    <td><input type="number" min="0" name="leprosy_20m" class="form-control"></td>
                    <td><input type="number" min="0" name="leprosy_20f" class="form-control"></td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <h4>Chronic diseases</h4>
	            ...
	            <table id="A4" class="center">
	                ...
	                <tr>
	                  ...
	                  <td class="grey"></td>
					        ...
					        <tr>
					          ...
					          <td><input type="number" min="0" name="hyper_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="hyper_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="hyper_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="hyper_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="hyper_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="hyper_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td class="grey"></td>
	                ...
	                <tr>
					          ...
					          <td><input type="number" min="0" name="asth_int_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_int_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_int_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_int_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_int_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_int_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>2</td>
					          <td class="left">Asthma persintent mild</td>
					          <td><input type="number" min="0" name="asth_mild_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mild_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mild_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mild_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mild_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mild_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>3</td>
					          <td class="left">Asthma persintent modarate</td>
					          <td><input type="number" min="0" name="asth_mod_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mod_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mod_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mod_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mod_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_mod_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>4</td>
					          <td class="left">Asthma persintent severe</td>
					          <td><input type="number" min="0" name="asth_sev_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_sev_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_sev_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_sev_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_sev_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="asth_sev_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>5</td>
					          <td class="left">Bronchitis</td>
					          <td><input type="number" min="0" name="bronch_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="bronch_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="bronch_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="bronch_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="bronch_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="bronch_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>6</td>
					          <td class="left">Other Chronic obstructive pulmonary diseases</td>
					          <td><input type="number" min="0" name="other_pulm_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_pulm_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_pulm_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_pulm_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_pulm_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_pulm_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td class="grey"></td>
	                ...
	                <tr>
					          ...
					          <td><input type="number" min="0" name="diab1_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab1_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="diab1_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab1_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="diab1_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab1_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>2</td>
					          <td class="left">Diabetes - Type 2</td>
					          <td><input type="number" min="0" name="diab2_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab2_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="diab2_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab2_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="diab2_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab2_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>3</td>
					          <td class="left">Diabetes gestational</td>
					          <td><input type="number" min="0" name="diab_gest_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab_gest_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="diab_gest_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab_gest_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="diab_gest_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="diab_gest_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td class="grey"></td>
	                ...
	                <tr>
	                  ...
	                  <td class="grey"></td>
					          <td><input type="number" min="0" name="breast_nc19f" class="form-control"></td>
	                  <td class="grey"></td>
					          <td><input type="number" min="0" name="breast_nc39f" class="form-control"></td>
	                  <td class="grey"></td>
					          <td><input type="number" min="0" name="breast_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>2</td>
					          <td class="left">Cervical cancer</td>
					          <td><input type="number" min="0" name="cervical_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="cervical_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="cervical_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="cervical_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="cervical_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="cervical_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>3</td>
					          <td class="left">Lymphoma</td>
					          <td><input type="number" min="0" name="lympho_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="lympho_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="lympho_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="lympho_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="lympho_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="lympho_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>4</td>
					          <td class="left">Leucamia</td>
					          <td><input type="number" min="0" name="leuca_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="leuca_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="leuca_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="leuca_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="leuca_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="leuca_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>5</td>
					          <td class="left">Colon recto cancer</td>
					          <td><input type="number" min="0" name="colon_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="colon_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="colon_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="colon_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="colon_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="colon_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>6</td>
					          <td class="left">Kaposi sarcoma</td>
					          <td><input type="number" min="0" name="kaposi_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="kaposi_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="kaposi_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="kaposi_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="kaposi_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="kaposi_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>7</td>
					          <td class="left">Retinoblastoma</td>
					          <td><input type="number" min="0" name="retino_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="retino_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="retino_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="retino_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="retino_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="retino_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>8</td>
					          <td class="left">Nephroblastoma</td>
					          <td><input type="number" min="0" name="nephro_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="nephro_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="nephro_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="nephro_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="nephro_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="nephro_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>9</td>
					          <td class="left">Ovarian cancer</td>
	                  <td class="grey"></td>
					          <td><input type="number" min="0" name="ovarian_nc19f" class="form-control"></td>
	                  <td class="grey"></td>
					          <td><input type="number" min="0" name="ovarian_nc39f" class="form-control"></td>
					          <td class="grey"></td>
					          <td><input type="number" min="0" name="ovarian_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>10</td>
					          <td class="left">Prostate cancer</td>
					          <td><input type="number" min="0" name="prostate_nc19m" class="form-control"></td>
	                  <td class="grey"></td>
					          <td><input type="number" min="0" name="prostate_nc39m" class="form-control"></td>
	                  <td class="grey"></td>
					          <td><input type="number" min="0" name="prostate_nc40m" class="form-control"></td>
	                  <td class="grey"></td>
					        </tr>
					        <tr>
					          <td>11</td>
					          <td class="left">Cancer others</td>
					          <td><input type="number" min="0" name="cancer_others_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="cancer_others_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="cancer_others_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="cancer_others_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="cancer_others_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="cancer_others_nc40f" class="form-control"></td>
					        </tr>
					      </tbody>
					    </table>
						</div>
            ...
            <h4>Other cardiovascular and kindney diseases</h4>
	            ...
	            <table id="A5" class="center">
	                ...
	                <tr>
	                  ...
	                  <td class="grey"></td>
					        ...
					        <tr>
					          ...
					          <td><input type="number" min="0" name="cardio_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="cardio_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="cardio_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="cardio_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="cardio_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="cardio_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>2</td>
					          <td class="left">Stroke/TIA</td>
					          <td><input type="number" min="0" name="stroke_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="stroke_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="stroke_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="stroke_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="stroke_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="stroke_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>3</td>
					          <td class="left">Rheumatic heart disease</td>
					          <td><input type="number" min="0" name="rheumatic_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="rheumatic_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="rheumatic_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="rheumatic_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="rheumatic_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="rheumatic_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>4</td>
					          <td class="left">Congenital heart disease</td>
					          <td><input type="number" min="0" name="cong_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="cong_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="cong_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="cong_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="cong_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="cong_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>5</td>
					          <td class="left">Coronary artery disease</td>
					          <td><input type="number" min="0" name="coronary_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="coronary_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="coronary_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="coronary_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="coronary_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="coronary_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>6</td>
					          <td class="left">Pericardial disease</td>
					          <td><input type="number" min="0" name="peri_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="peri_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="peri_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="peri_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="peri_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="peri_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>7</td>
					          <td class="left">Heart failure</td>
					          <td><input type="number" min="0" name="heart_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="heart_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="heart_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="heart_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="heart_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="heart_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>8</td>
					          <td class="left">Other cardiovascular</td>
					          <td><input type="number" min="0" name="other_cardio_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_cardio_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_cardio_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_cardio_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_cardio_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_cardio_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>9</td>
					          <td class="left">Post heart surgery</td>
					          <td><input type="number" min="0" name="post_heart_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="post_heart_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="post_heart_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="post_heart_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="post_heart_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="post_heart_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td class="grey"></td>
	                ...
	                <tr>
					          ...
					          <td><input type="number" min="0" name="renal_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="renal_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="renal_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="renal_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="renal_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="renal_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>2</td>
					          <td class="left">Other chonic kidney diseases</td>
					          <td><input type="number" min="0" name="other_chronic_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_chronic_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_chronic_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_chronic_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_chronic_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_chronic_nc40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td class="grey"></td>
	                ...
	                <tr>
					          ...
					          <td><input type="number" min="0" name="thyroid_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="thyroid_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="thyroid_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="thyroid_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="thyroid_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="thyroid_nc40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>2</td>
					          <td class="left">Other endocrine and metabolic diseases</td>
					          <td><input type="number" min="0" name="other_endo_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_endo_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_endo_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_endo_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_endo_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_endo_nc40f" class="form-control"></td>
					        </tr>
					      </tbody>
					    </table>
						</div>
	            ...
	            <table id="A6" class="center">
					      ...
					      <tbody>
					        <tr>
					          ...
					          <td><input type="number" min="0" name="road_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="road_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="road_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="road_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="road_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="road_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="road_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="road_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="road_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="road_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="road_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="road_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>2</td>
					          <td class="left">Self-harm</td>
					          <td><input type="number" min="0" name="self_harm_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="self_harm_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>3</td>
					          <td class="left">Interpersonal violence</td>
					          <td><input type="number" min="0" name="inter_violence_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="inter_violence_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>4</td>
					          <td class="left">Other intentional injuries</td>
					          <td><input type="number" min="0" name="other_injury_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_injury_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>5</td>
					          <td class="left">Falls</td>
					          <td><input type="number" min="0" name="falls_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="falls_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>6</td>
					          <td class="left">Drowning</td>
					          <td><input type="number" min="0" name="drowning_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="drowning_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>7</td>
					          <td class="left">Fire/burns (thermo, electrical, chemical)</td>
					          <td><input type="number" min="0" name="fire_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="fire_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>8</td>
					          <td class="left">Animal contact</td>
					          <td><input type="number" min="0" name="animal_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="animal_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>9</td>
					          <td class="left">Poisoning</td>
					          <td><input type="number" min="0" name="poison_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="poison_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>10</td>
					          <td class="left">Natural disasters</td>
					          <td><input type="number" min="0" name="natural_disasters_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="natural_disasters_d40f" class="form-control"></td>
					        </tr>
					        <tr>
					          <td>11</td>
					          <td class="left">Adverse effects of medical treatment</td>
					          <td><input type="number" min="0" name="ad_effects_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="ad_effects_d40f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>12</td>
					          <td class="left">Other unintentional injuries</td>
					          <td><input type="number" min="0" name="other_unintent_nc19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_nc19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_nc39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_nc39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_nc40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_nc40f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_d19m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_d19f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_d39m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_d39f" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_d40m" class="form-control"></td>
					          <td><input type="number" min="0" name="other_unintent_d40f" class="form-control"></td>
					        </tr>
					      </tbody>
					    </table>
						</div>
	            ...
	            <table id="A7" class="center">
					      ...
					      <tbody>
					        <tr>
					          ...
					          <td><input type="number" min="0" name="oc_19m" class="form-control"></td>
					          <td><input type="number" min="0" name="oc_19f" class="form-control"></td>
					          <td><input type="number" min="0" name="oc_20m" class="form-control"></td>
					          <td><input type="number" min="0" name="oc_20f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>2</td>
					          <td class="left">Patients in palliative care new cases this month (new cases)</td>
					          <td><input type="number" min="0" name="nc_19m" class="form-control"></td>
					          <td><input type="number" min="0" name="nc_19f" class="form-control"></td>
					          <td><input type="number" min="0" name="nc_20m" class="form-control"></td>
					          <td><input type="number" min="0" name="nc_20f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>3</td>
	                ...
	                <tr>
					          ...
					          <td><input type="number" min="0" name="morphine_19m" class="form-control"></td>
					          <td><input type="number" min="0" name="morphine_19f" class="form-control"></td>
					          <td><input type="number" min="0" name="morphine_20m" class="form-control"></td>
					          <td><input type="number" min="0" name="morphine_20f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>5</td>
					          <td class="left">Died received end of life care and bereavement support</td>
					          <td><input type="number" min="0" name="end_life_19m" class="form-control"></td>
					          <td><input type="number" min="0" name="end_life_19f" class="form-control"></td>
					          <td><input type="number" min="0" name="end_life_20m" class="form-control"></td>
					          <td><input type="number" min="0" name="end_life_20f" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>6</td>
					          <td class="left">Total death in palliative care</td>
					          <td><input type="number" min="0" name="death_19m" class="form-control"></td>
					          <td><input type="number" min="0" name="death_19f" class="form-control"></td>
					          <td><input type="number" min="0" name="death_20m" class="form-control"></td>
					          <td><input type="number" min="0" name="death_20f" class="form-control"></td>
					        </tr>
					      </tbody>
					    </table>
						</div>
	            ...
	            <table id="A8" class="center">
					      ...
					      <tbody>
					        <tr>
					          ...
					          <td><input type="number" min="0" name="annual_chekup" class="form-control"></td>
					        </tr>
									<tr>
                    <td class="grey"></td>
	                ...
	                <tr>
					          ...
					          <td><input type="number" min="0" name="cardio" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>3</td>
					          <td class="left">Chronic respiratory diseases</td>
					          <td><input type="number" min="0" name="respiratory" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>4</td>
					          <td class="left">Diabetes</td>
					          <td><input type="number" min="0" name="diabetes" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>5</td>
					          <td class="left">Renal disease</td>
					          <td><input type="number" min="0" name="renal" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>6</td>
					          <td class="left">Cancer</td>
					          <td><input type="number" min="0" name="cancer" class="form-control"></td>
					        </tr>
									<tr>
					          <td>7</td>
					          <td class="left">Disability</td>
					          <td><input type="number" min="0" name="disability" class="form-control"></td>
					        </tr>
					      </tbody>
					    </table>
						</div>
	            ...
	            <table id="A9" class="center">
					      ...
					      <tbody>
					        <tr>
					          ...
					          <td><input type="number" min="0" name="cervical" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>2</td>
					          <td class="left">Women tested VIA positive during cervical cancer screening</td>
					          <td><input type="number" min="0" name="cervical_viap" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>3</td>
					          <td class="left">Women tested VIA positive during cervical cancer screening and HIV positive</td>
					          <td><input type="number" min="0" name="cervical_viap_hivp" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>4</td>
					          <td class="left">Women tested VIA positive and treated with cryotherapy</td>
					          <td><input type="number" min="0" name="cryo_viap" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>5</td>
					          <td class="left">Women tested VIA positive and referred for treatment</td>
					          <td><input type="number" min="0" name="treatement_viap" class="form-control"></td>
					        </tr>
	                <tr>
					          <td>6</td>
					          <td class="left">Women screened for breast cancer</td>
					          <td><input type="number" min="0" name="breast_screened" class="form-control"></td>
					        </tr>
									<tr>
					          <td>7</td>
					          <td class="left">Women referred for breast cancer</td>
					          <td><input type="number" min="0" name="breast_referred" class="form-control"></td>
					        </tr>
									<tr>
					          <td>8</td>
					          <td class="left">Women suspected for cervical cancer referred to other level</td>
					          <td><input type="number" min="0" name="cervical_otherlevel" class="form-control"></td>
					        </tr>
									<tr>
					          <td>9</td>
					          <td class="left">Biopsies collected for all types of cancer</td>
					          <td><input type="number" min="0" name="biopsies" class="form-control"></td>
					        </tr>
					      </tbody>
					    </table>
						</div>
