<html>
	...
	<body>
		<div class="container">
			...
			<center>
				<b>By day : </b><input id="date" type="date" onchange="change()">
				<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Or&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>
				<b>From : </b><input id="date1" type="date" onchange="change2()">
				<b>To : </b><input id="date2" type="date" onchange="change2()">
			</center>
			<div id="result"></div>
    </div>
...
$(document).ready(function(){
	...
	function load_data2(date1, date2){
		$.ajax({
			url:"<?php echo base_url('research/fetch2');?>",
			method:"POST",
	...
	$('#date1').bind('change keyup', function(){
		load_data2($('#date1').val(), $('#date2').val());
	});
