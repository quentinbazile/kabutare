...
class gbv_model extends CI_Model
{
    ...
    public function fetch_data2(
      ...
      $this->db->where('date_gender_based_violence', $this->session->userdata('add_date'));
      $q = $this->db->get('Gender_Based_Violence');
      if ($q->num_rows() == 0) {
        return $this->db->set(array(
      ...
      'num_rapport' => $num_rapport
          ...
          ->where('date_gender_based_violence', $this->session->userdata('add_date'));
    ...
    {
        return $this->db->where('date_gender_based_violence', $this->session->userdata('update_date'))
    ...
    public function update_data2(
      ...
      $exposure_hiv_25m
        ...
        $this->db->where('date_gender_based_violence', $this->session->userdata('update_date'));
        return $this->db->update('Gender_Based_Violence');
    }
}
