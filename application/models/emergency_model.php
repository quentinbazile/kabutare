...
class emergency_model extends CI_Model
{
    ...
    public function fetch_data3(
      ...
      $cancer_deaths20f,
        ...
        return $this->db->set(array(
          ...
          'gastritis_death5m' => $gastritis_death5m,
          'gastritis_death5f' => $gastritis_death5f,
          'gastritis_death19m' => $gastritis_death19m,
          'gastritis_death19f' => $gastritis_death19f,
          'gastritis_death20m' => $gastritis_death20m,
          'gastritis_death20f' => $gastritis_death20f,
    ...
    public function update_data3(
      ...
      $cancer_deaths20f
        ...
        $this->db->set('gastritis_death5m', $gastritis_death5m);
        $this->db->set('gastritis_death5f', $gastritis_death5f);
        $this->db->set('gastritis_death19m', $gastritis_death19m);
        $this->db->set('gastritis_death19f', $gastritis_death19f);
        $this->db->set('gastritis_death20m', $gastritis_death20m);
        $this->db->set('gastritis_death20f', $gastritis_death20f);
